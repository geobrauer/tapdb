...
This program taps a SQLite database directly to render flashcards from up to 4 columns in a given table.
...
This flashcard viewer is meant to address a shortcoming of Anki
